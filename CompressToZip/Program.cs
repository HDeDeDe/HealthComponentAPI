...
if (Settings.weave) {
	...
	File.Copy(dllPath + Settings.pluginName + ".dll", 
		dllPath + Settings.pluginName + ".dll.prepatch");
	File.Copy(dllPath + Settings.pluginName + ".pdb", 
		dllPath + Settings.pluginName + ".pdb.prepatch");
